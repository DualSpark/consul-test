...
sudo cp /opt/app/templates/consul-bootstrap-config.json /etc/consul.d/bootstrap/config.json
sudo cp /opt/app/templates/consul-server-config.json /etc/consul.d/server/config.json
