...
sudo cp /opt/app/templates/consul-agent-jenkins-config.json /etc/consul.d/client/config.json
sudo cp /opt/app/templates/consul-agent-config.txt /etc/init/consul.conf
sudo cp /opt/app/templates/web-nginx.json /etc/consul.d/client
